  ...
  return (
    <section className="flex items-center min-h-screen">
      ...
      <div className="grid items-start grid-cols-1 lg:grid-cols-2 lg:gap-12 gap-y-8">
        {/* Right block */}
        <div className="flex flex-col items-start justify-center order-1 p-2 pb-20 lg:order-1 md:pb-10 lg:pt-10">
          {/* Text hightlight */}
        ...
        <div className="order-2 lg:order-2 from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37]">
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            ...
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              {/* Strengths */}
              {/* <div>
                <span className="ml-4 mr-2 text-white lg:ml-8">strengths:</span>
                <span className="text-gray-400">{"{"}</span>
                
                <span className="text-green-400">
                  "technical insights into strategic business solutions, driving innovation and problem-solving."
                </span>
                <span className="text-gray-400">{"},"}</span>
              </div> */}
              ...
              <div>
                ...
                <span className="text-gray-400">{"{"}</span>
                <div>
                  <span className="ml-8 mr-2 text-white lg:ml-16">
                    Storytelling:
                  </span>
              ...
              {/* Hireable function */}
              <div>
                <span className="ml-4 mr-2 text-white lg:ml-8">hireable:</span>
